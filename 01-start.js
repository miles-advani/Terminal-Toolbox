...
// const { getUserLocation, getLocalTime } = require("./common.js");
const { getInfo } = require("./02-info.js");
...
function askNextAction() {
  ...
  rl.question(
    "Would you like to retrieve the weather forecast or start the calculator? (weather/calculator): ",
    (answer) => {
      rl.close();
      if (answer === "weather") {
        getWeatherForecast();
